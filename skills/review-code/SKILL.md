...
```sh
~/.claude/scripts/get-pr-context.sh [PR_NUMBER]    # Full PR context
~/.claude/scripts/get-failing-checks.sh [PR_NUMBER] # CI failure logs
~/.claude/scripts/gh-issue.sh [ISSUE_NUMBER]        # Issue context
```
...
See also: `~/.claude/patterns/detection-signals.md`, `~/.claude/concepts/code-review.md`
