...
Reference `~/.claude/skills/review-code/patterns/INDEX.md` for pattern appropriateness checks.
...
```
@~/.claude/skills/review-code/patterns/gof/behavioral/strategy.md
@~/.claude/skills/review-code/patterns/reliability/circuit-breaker.md
@~/.claude/skills/review-code/patterns/anti-patterns/god-object.md
```
