...
## Deep Dives
See `~/.claude/concepts/language-standards/python/` for focused files on types, exceptions, patterns, paths, datastructures, async, testing, logging, and AI anti-patterns.
