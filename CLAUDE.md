...
|---------|------------|---------|
| User docs (README) | `~/.claude/` | `~/.claude/scripts/get-pr-context.sh` |
| Agent implements | Relative | `concepts/code-review.md` |
| Agent deep dives | `~/.claude/` | `~/.claude/concepts/language-standards/go/` |
